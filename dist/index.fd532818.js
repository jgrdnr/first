...
})({"2Qicn":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 8081;
...
async function confirmed() {
 const countries = ["afghanistan", "albania", "algeria", "andorra", "argentina", "armenia", "australia", "austria", "azerbaijan", "bahamas", "bahrain", "bangladesh", "barbados", "belgium", "brazil", "chad", "czechia", "egypt", "jamaica", "kenya", "kuwait", "lebanon", "liechtenstein", "madagascar", "maldives", "micronesia", "mongolia", "mozambique", "netherlands", "niger", "oman", "poland", "russia", "united kingdom", "uzbekistan", "yemen", "zambia"];
 var randomIndex =  Math.floor(Math.random()*countries.length);
 const cases = await fetch("https://covid19.mathdro.id/api/countries/" + countries[randomIndex])
 .then(result=>result.json())
 .then(data=>{
   const confirm = data.confirmed.value
   console.log(confirm)
   console.log(countries[randomIndex])
   document.getElementById("country").innerText = countries[randomIndex]
   document.getElementById("cases").innerText = confirm

 })
}

},{}]},["2Qicn","4ee1I"], "4ee1I", "parcelRequire04d5")
